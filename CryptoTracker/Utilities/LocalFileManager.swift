...
class LocalFileManager {
    ...
    private func createFolderIfNeeded(folderName: String) {
        guard let url = getURLForeFolder(folderName: folderName) else { return }
    ...
    private func getURLForeFolder(folderName: String) -> URL? {
    ...
    private func getURLForImage(imageName: String, folderName: String) -> URL? {
        guard let folderURL = getURLForeFolder(folderName: folderName) else {
            return nil
        }
